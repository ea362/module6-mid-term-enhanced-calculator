...
def test_export_filtered_history(tmp_path, monkeypatch):
    ...
    # Export with filters: use capitalized operation name
    calc.export_filtered_history_to_csv(operation="Addition", min_value=Decimal("5"))
    calc.export_filtered_history_to_excel(operation="Addition", min_value=Decimal("5"))
